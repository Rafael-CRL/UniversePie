...
**Tipo: registro — migrado.** Os quatro achados aceitos estão nos ADRs `0005` e `0010`, no `debito-tecnico.md` item 5 e no `roadmap.md`; os quatro rejeitados, na seção de fechamento. Ler a triagem antes do corpo — o único achado classificado como GRAVE é falso positivo.
...
**Onde:** [ai-rules.md](../../docs/ai-rules.md#L67-L81) · [premissas.md](../../docs/premissas.md#L26-L28)
...
**Onde:** [ADR 0005](../../docs/decisoes/0005-anki-fonte-de-material.md#L27-L30) · [debito-tecnico.md item 1](../../docs/debito-tecnico.md#L32-L34) · [premissas.md](../../docs/premissas.md#L61-L74)
...
**Onde:** [premissas.md](../../docs/premissas.md#L101-L117)
...
**Onde:** [ADR 0009](../../docs/decisoes/0009-unidade-de-conhecimento.md#L32-L33) · [ADR 0010](../../docs/decisoes/0010-lista-de-conceitos.md)
...
> [!TIP]
> O skill [prompt-review.md](../../skills/prompt-review.md) e o auditor existente podem servir de base para um procedimento de auditoria da ingestão, mas isso precisa ser planejado explicitamente.
...
**Onde:** [ADR 0007](../../docs/decisoes/0007-autorrelato-e-comando.md#L18-L25)
...
**Onde:** [roadmap.md](../../docs/roadmap.md#L48) · [premissas.md](../../docs/premissas.md#L127-L134)
...
| ADR | Veredicto |
|-----|-----------|
| [0001](../../docs/decisoes/0001-pool-em-lote.md) | Completo. Contexto/decisão/consequências claros. Efeito colateral medido (73% vazamento) |
| [0002](../../docs/decisoes/0002-rotacao-de-estrategias.md) | Bem escrito. Identifica seu próprio defeito e registra revisão pendente |
| [0003](../../docs/decisoes/0003-cloze-como-producao-ativa.md) | Completo. Alternativas rejeitadas documentadas com motivo |
| [0004](../../docs/decisoes/0004-string-matching-no-cloze.md) | Completo. Escopo bem delimitado (congela avaliação por IA, não normalização) |
| [0006](../../docs/decisoes/0006-medida-nasce-na-ferramenta.md) | Completo. Rejeição explícita de calibração inicial é coerente |
| [0008](../../docs/decisoes/0008-trilha-e-espelho.md) | Lógica sólida. A diferença entre espelho e prescrição está bem nomeada |
| [0009](../../docs/decisoes/0009-unidade-de-conhecimento.md) | Fundamentação forte. É a base matemática da trilha |
| [0010](../../docs/decisoes/0010-lista-de-conceitos.md) | O mais completo. O raciocínio de versionamento é concreto |
| [0011](../../docs/decisoes/0011-origem-da-evidencia.md) | Bem estruturado. Tensão futura registrada em vez de ignorada |
| [0012](../../docs/decisoes/0012-memoria-em-sqlite.md) | Objetivo e correto |
| [0013](../../docs/decisoes/0013-ordem-de-execucao.md) | Raciocínio tático correto (isolar variáveis de melhoria) |

### O que precisa de atenção

| ADR | Problema |
|-----|----------|
| [0004](../../docs/decisoes/0004-string-matching-no-cloze.md) | Não discute por que `acceptable_alternatives` no payload de geração não pode cobrir conjugações. Essa saída intermediária (entre string matching puro e avaliação por IA) não foi avaliada |
| [0005](../../docs/decisoes/0005-anki-fonte-de-material.md) | Ambiguidade sobre como usar cards com alto `lapses` (ver item 2.2 acima) |
| [0007](../../docs/decisoes/0007-autorrelato-e-comando.md) | Caso de conflito desempenho vs. autorrelato não resolvido (ver item 2.5) |
